const cardItems = [
  {
    ...
    text: "Amanda har ansvarat för att skapa en fungerande hemsida där produkten ska appliceras men även byggt upp startsidan med animationer och “om projektet” sidan. Hon har även, utifrån de förutsättningar och tid vi har, arbetat för en så responsiv hemsida och produkt som möjligt. Amanda har kopplat samman de olika delar och sett till att hemsidan är tillgänglig och fungerande.",
  ...
  },
  {
    ...
    text: "Som gruppens UX-designer har Moa bland annat tagit ansvar för att få igång idégeneringen samt bygga upp visuella prototyper utifrån gruppens idéer och tankar, som vi kunnat utgå från under projektets gång. Moa har arbetat med text och färg där enhetlighet och temat kärlek har varit i fokus. Moa har även genomfört användartester på produkten och arbetat mot en användarvänlig produkt.",
